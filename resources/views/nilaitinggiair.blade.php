    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Table Tinggi Air</h4>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Tabel Tinggi Air</h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>{{ $datatinggi->links() }}</div>
                                    <div>
                                        <form action="{{ url('nilaitinggiair/exporttinggi/excel') }}" method="GET">
