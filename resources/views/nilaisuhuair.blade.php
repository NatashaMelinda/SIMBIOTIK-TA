            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Tabel Nilai Suhu Air</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tabel Nilai Suhu Air</h4>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>{{ $data->links() }}</div>
                                            <div>
                                                <form action="{{ url('nilaisuhuair/export/excel') }}" method="GET">
